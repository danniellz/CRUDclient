...
public class ClienteRESTclient {
    ...
    public <T> T findAllClienteWithIncidencia(Class<T> responseType) throws ClientErrorException {
    ...
    public <T> T findClienteByFullName(Class<T> responseType, String fullName) throws ClientErrorException {
        WebTarget resource = webTarget;
